...
def evaluate_hull(hull: Hull, resistance_method: str = "auto") -> EvaluationResult:
    ...
    limitations = ["Modelo preliminar para triagem de conceito.", "Não substitui normas, responsabilidade técnica, modelo 3D, curvas hidrostáticas reais, CFD, FEA, ensaio ou prova de mar.", "Savitsky atual é scaffold de triagem, não implementação final validada."]
